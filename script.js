document.querySelector(".tombol").addEventListener("click", function() {
    let balon = document.querySelectorAll(".balloon");

    document.querySelector(".bubu").classList.add("munculGambar");
    document.querySelector("h1").classList.add("munculTeks");

    for(let i = 0; i < 10; i++){
        balon[i].classList.add("muncul");
    }
});

document.querySelector(".bubu").addEventListener("click", function(){
    document.querySelector(".bubu").classList.remove("munculGambar");
